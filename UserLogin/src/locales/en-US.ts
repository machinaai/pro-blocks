export default {
  ...
  'USER_Name.text.title': 'Account password login',
  'USER_Name.text.placeholder': 'userName: admin or user',
  'USER_Name.text.name': 'userName',
  'USER_Name.text.subtitle': 'Incorrect account or password（admin/ant.design）',
  'USER_Name.password.title': 'Password',
  'USER_Name.password.placeholder': 'password: machina.ai',
  'USER_Name.text.mobile.title': 'Mobile login',
  'USER_Name.text.mobile.error': 'Vertification code errror',
  'USER_Name.mobile.placeholder': 'Phoner number',
  'USER_Name.captcha.placeholder': 'Verification code',
  'USER_Name.userName.message': 'please enter a user name!',
  'USER_Name.password.message': 'please enter the password!',
  'USER_Name.captcha.message': 'please enter a verification code',
  'USER_Name.checkbox': 'Remember me',
  'USER_Name.forgo.password': 'Forgot Password',
  'USER_Name.log.in': 'Log in',
  'USER_Name.loging.methods': 'Other login methods',
  'USER_Name.register.account': 'Register Account',
  'USER_Name.mobile.message.number': 'please enter a phone number!',
  'USER_Name.mobile.message.error.number': 'Malformed phone number!',
};
